...
export const sourceItems = [
  { source: "教育部", date: "2025-09-24", title: "2026 初试时间定为 12-20/21", tag: "权威", color: "violet" },
  { source: "新华社", date: "2025-09-24", title: "初试时间公布快讯", tag: "媒体", color: "blue" },
  { source: "研招网", date: "2025-09-30", title: "正式报名 10-16~27，预报名 10-10~13", tag: "报名", color: "amber" },
  { source: "研招网", date: "2025-10-17", title: "网上确认时间汇总（多省）", tag: "确认", color: "cyan" },
  { source: "研招网", date: "2025-10-27", title: "甘肃省确认：11-1~11-5", tag: "确认", color: "cyan" },
  { source: "研招网", date: "2025-10-28", title: "北京、江苏确认提醒", tag: "确认", color: "cyan" },
  { source: "上海研招网", date: "2025-09-30", title: "上海确认安排 10-31~11-5", tag: "确认", color: "cyan" },
  ...
  { source: "新东方", date: "2025-09-19", title: "政治大纲要点与获取方式", tag: "大纲", color: "emerald" },
  { source: "Koolearn", date: "2025-09-04", title: "数学大纲解读与重点", tag: "大纲", color: "emerald" },
  { source: "新东方", date: "2025-11-07", title: "大纲深度解读（直播/回放）", tag: "大纲", color: "emerald" }
];
