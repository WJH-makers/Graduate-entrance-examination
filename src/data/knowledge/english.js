export const englishKnowledge = [
  ...
  },
  {
    ...
    examTips: ['It is said that…→据说；be done by… 若无必要可省去 by 短语。'],
  },
  {
    id: 'e50',
    category: 'Grammar',
    ...
    tags: ['语法', '虚拟'],
    content:
      '与现在/将来事实相反：主句 would do，从句 did；与过去事实相反：主句 would have done，从句 had done。',
    examTips: ['常见结构：If only/It is high time/ as if/ would rather。'],
  },
  {
    id: 'e51',
    category: 'Writing',
    ...
    examTips: ['保持礼貌：I would appreciate it if… / I am terribly sorry for…'],
  },
  {
    id: 'e52',
    category: 'Writing',
    ...
    tags: ['写作', '衔接'],
    content:
      '并列 and/furthermore; 转折 however/nevertheless; 因果 therefore/as a result; 举例 for example; 让步 although/even if。',
    examTips: ['一篇作文控制 3-4 个高频连接词，避免重复。'],
  },
  {
    id: 'e53',
    category: 'Vocabulary',
    ...
    examTips: ['遇到形近词，先看搭配介词与主语宾语是否合理。'],
  },
  {
    id: 'e54',
    category: 'Reading',
    ...
    examTips: ['排除比原文更绝对/更广的选项；优先与原文语义方向一致且强度减弱的表述。'],
  },
  {
    id: 'e55',
    category: 'Grammar',
  ...
  },
  {
    ...
    examTips: ['提前预览选项，预测话题；注意强调词、转折词。'],
  },
  {
    id: 'e57',
    category: 'Writing',
    ...
    tags: ['写作', '图表'],
    content:
      '开头描述趋势：The chart reveals that…；数据变化：increase from A to B by C%；对比：A is twice as much as B。',
    examTips: ['注意时态一致；描述比例用 one in four / a quarter。'],
  },
  {
    id: 'e58',
    category: 'Reading',
    ...
    examTips: ['每段做标记，避免重复阅读；答案顺序通常不完全线性。'],
  },
  {
    id: 'e59',
    category: 'Vocabulary',
    ...
    tags: ['词汇', '主题'],
    content:
      '科技：innovation, algorithm, automation, data privacy；环保：sustainability, emission, biodiversity；教育：curriculum, literacy；健康：immunity, nutrition。',
    examTips: [
