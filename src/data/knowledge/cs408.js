export const cs408Knowledge = [
  ...
  },
  {
    ...
    tags: ['分布式', '一致性哈希', '负载均衡'],
    content:
      '一致性哈希通过环和虚拟节点让节点增删时仅影响相邻数据，降低重分布成本；常用于分布式缓存/存储。',
    classicProblems: [
      {
        title: '节点扩容影响范围',
  ...
  },
  {
    ...
    tags: ['内存管理', '分页', '分段'],
    content:
      '分页按等长页框，分段按逻辑分段变长；段页式综合：先段再页。考点：内外碎片、地址转换、共享、保护。分页无外碎片但有内碎片；分段相反。',
    classicProblems: [
      {
        title: '地址转换示例',
        description: '给出段表/页表，线性地址求物理地址',
        solution:
          '段页式：线性地址=段号|段内页号|页内偏移；先查段表得基址+界限检查，再查页表得帧号拼偏移。',
      },
    ],
    examTips: ['比较三者：碎片、共享、扩展、实现复杂度；画三栏对比表快速背诵。'],
  },
  {
    id: 'cs42',
    category: 'Operating Systems',
    ...
    tags: ['同步', '信号量', '并发'],
    content:
      '三大模型考察信号量或监视器写法：生产者消费者用 empty/full+互斥；读写锁读共享写独占；哲学家避免死锁可奇偶抢叉或限制同时进餐人数。',
    examTips: ['写伪代码时“P 同步→P 互斥→临界区→V 互斥→V 同步”，顺序不要反；给出避免死锁策略。'],
  },
  {
    id: 'cs43',
    category: 'Operating Systems',
    ...
    tags: ['调度', '周转时间'],
    content:
      'FCFS、SJF、HRRN、RR、优先级、多级反馈队列：响应时间/周转时间/饥饿风险不同。多级反馈常考思路：时间片递减、低级可被高级抢占。',
    examTips: ['给平均周转/带权周转计算；说明 RR 时间片过大趋 FCFS，过小开销大。'],
  },
  {
    id: 'cs44',
    category: 'Operating Systems',
    ...
    tags: ['置换', '缺页'],
    content:
      'OPT 理论最优；FIFO 可能 Belady；LRU 近似 OPT；Clock 近似 LRU；LFU 记录访问次数易被偶发访问污染。',
    examTips: ['给引用串快速判缺页：画栈式 LRU/FIFO；说明 Belady 只在 FIFO 可能出现。'],
  },
  {
    id: 'cs45',
    category: 'Computer Organization',
    ...
    tags: ['流水线', '冒险'],
    content:
      '结构/数据/控制冒险；解决：前递、插入气泡、分支预测、延迟槽；多发射需同时考虑端口冲突。',
    examTips: ['记 CPI≈理想 CPI + 冒险开销；分支预测失误率影响性能；画时间线找气泡。'],
  },
  {
    id: 'cs46',
    category: 'Computer Organization',
    ...
    tags: ['Cache', '一致性', '多核'],
    content:
      '直接映射/全相联/组相联地址格式；写策略写回+脏位/写直达+写缓冲；多核一致性 MESI 基本思路。',
    examTips: ['给地址拆 tag/index/offset；一致性写出 MESI 状态与总线事务。'],
  },
  {
    id: 'cs47',
    category: 'Data Structures',
    ...
    importance: 3,
    frequency: 3,
    tags: ['Dijkstra', 'Bellman-Ford', 'SPFA'],
    content:
      '无负权：Dijkstra（堆 O(E log V)）；有负权边无负环：Bellman-Ford O(VE)；多源或稀疏图可 SPFA 但最坏 O(VE)；全源 Floyd O(V^3)。',
    examTips: ['先检查负边；输出路径需前驱数组；Dijkstra 不能处理负权。'],
  },
  {
    id: 'cs48',
    category: 'Data Structures',
    ...
    examTips: ['实现时注意边排序、判环 find(u)!=find(v)；稠密图 Prim+堆可能更优。'],
  },
  {
    id: 'cs49',
    category: 'Data Structures',
    ...
    examTips: ['线性探测易主聚集；二次探测需表长素数；链地址支持删除简单。'],
  },
  {
    id: 'cs50',
    category: 'Computer Networks',
    ...
    tags: ['TCP', '拥塞控制'],
    content:
      '慢开始 cwnd=1 MSS 指数涨到 ssthresh，再线性加；超时阈值减半回慢开始；快重传/快恢复 3ACK 触发，cwnd 减半进入拥塞避免。',
    examTips: ['画 cwnd 曲线；记 ssthresh 更新：超时=阈值减半，快重传=阈值减半+进入避免。'],
  },
  {
    id: 'cs51',
    category: 'Computer Networks',
    ...
    tags: ['路由', '距离向量', '链路状态'],
    content:
      '距离向量：Bellman-Ford 迭代，慢收敛有计数到无穷；链路状态：Dijkstra，全局视图，需洪泛同步。',
    examTips: ['距离向量加毒性逆转/水平分割缓解环路；OSPF 属链路状态，RIP 属距离向量。'],
  },
  {
    id: 'cs52',
    category: 'Computer Networks',
    ...
    tags: ['HTTP', 'QUIC'],
    content:
      'HTTP/1.1 管线易队头阻塞；HTTP/2 多路复用+头部压缩；HTTP/3 基于 QUIC(UDP)+TLS1.3，解决 TCP 队头阻塞。',
    examTips: ['记“1.1 keep-alive，2 多路复用，3 QUIC”口诀；可能考端口/握手差异。'],
  },
  {
    id: 'cs53',
    category: 'Exam Year',
    ...
    tags: ['预测', '真题趋势'],
    content:
      '预计加强 OS 与网络应用题，关注同步/虚拟化/一致性；数据结构偏工程场景（哈希+链表混合）；计组关注流水线与 Cache。',
    examTips: ['按权重复习：数据结构45/计组45/OS35/网络25；每周一套综合卷计时。'],
  },
  {
    id: 'cs42',
    category: 'Operating Systems',
    ...
    tags: ['同步', '信号量', '并发'],
    content:
      '生产者-消费者：empty/full + mutex；读写锁：读共享写独占；哲学家：限制进餐人数或奇偶抢叉避免死锁。',
    examTips: ['信号量顺序 P 同步→P 互斥→临界区→V 互斥→V 同步；写死锁避免策略。'],
  },
  {
    id: 'cs43',
    category: 'Operating Systems',
    ...
    tags: ['调度', '周转'],
    content:
      'FCFS 简单但响应差；SJF/HRRN 平均周转最优但可能饥饿；RR 兼顾响应，时间片过小开销大；多级反馈兼顾长短作业。',
    examTips: ['计算平均周转/带权周转；RR 时间片→FCFS/开销权衡。'],
  },
  {
    id: 'cs44',
    category: 'Operating Systems',
    ...
    examTips: ['画栈式演示；Belady 仅 FIFO 可能发生。'],
  },
  {
    id: 'cs45',
    category: 'Operating Systems',
    ...
    examTips: ['调 Δ 与帧数控制缺页率；LRU 近似工作集。'],
  },
  {
    id: 'cs46',
    category: 'Operating Systems',
  ...
  },
  {
    ...
    examTips: ['多线程提升并发但需同步；线程切换开销小于进程。'],
  },
  {
    id: 'cs49',
    category: 'Computer Organization',
    ...
    examTips: ['画时间表定位气泡；分支预测失误率影响 CPI。'],
  },
  {
    id: 'cs50',
    category: 'Computer Organization',
    ...
    examTips: ['地址分解 tag/index/offset；命中/未命中路径要清楚。'],
  },
  {
    id: 'cs51',
    category: 'Computer Organization',
  ...
  },
  {
    ...
    examTips: ['Kruskal 先排序边；Prim 任一点起。'],
  },
  {
    id: 'cs63',
    category: 'Data Structures',
  ...
  },
  {
    ...
    examTips: ['TIME_WAIT=2MSL；半关闭一端可收不可发。'],
  },
  {
    id: 'cs67',
    category: 'Computer Networks',
    ...
    examTips: ['实时/流媒体用 UDP；文件/可靠用 TCP。'],
  },
  {
    id: 'cs68',
    category: 'Computer Networks',
  ...
  },
  {
    ...
    examTips: ['端口 25/465/587,110,143/993。'],
  },
  {
    id: 'cs75',
    category: 'Computer Networks',
    ...
    examTips: ['签名=哈希+私钥；握手用非对称交换会话密钥。'],
  },
  {
    id: 'cs76',
    category: 'Computer Networks',
  ...
  },
  {
    ...
    examTips: ['零拷贝 sendfile/mmap；AIO/IO_uring。'],
  },
  {
    id: 'cs80',
    category: 'Computer Organization',
    ...
    examTips: ['代入 miss rate 与 penalty。'],
  },
  {
    id: 'cs81',
    category: 'Computer Organization',
  ...
  },
  {
    ...
    examTips: ['计算 CPI 时分别统计冒险插入的停顿周期。', '画时间表可直观看出哪几拍需要气泡。'],
  },
  {
    id: 'cs104',
    category: 'Computer Organization',
  ...
  },
  {
    ...
    tags: ['MESI', 'coherence'],
    content:
      '四状态：Modified、Exclusive、Shared、Invalid。总线监听实现：写操作触发失效或升级，读共享触发降级。',
    secondaryConclusions: [
      '写命中 Shared 需升级为 Modified（广播无效）。',
      '目录协议可降低总线广播开销。',
    ],
    examTips: ['状态转移图是高频简答，画出触发条件即可得分。', '问一致性时区分写失效 vs 写更新。'],
  },
  {
    id: 'cs106',
    category: 'Computer Organization',
    ...
    tags: ['branch', 'BTB'],
    content:
      '静态预测（后向跳转取、前向不取）简单；动态两位饱和计数器抗抖动；BTB 存目标地址减少延迟。',
    secondaryConclusions: [
      '局部历史 + 全局历史的两级预测准确率更高。',
      '预测失败需清空后续指令并恢复 PC。',
    ],
    examTips: ['CPI 题：额外开销 = 失败率 × 惩罚拍数。', 'BTB 未命中时仍需顺序取指。'],
  },
  {
    id: 'cs107',
    category: 'Computer Organization',
    ...
    tags: ['DMA', 'interrupt'],
    content:
      'DMA 由控制器直接搬运数据，CPU 仅发起与结束中断；中断方式每次数据都需 CPU 参与，适合低速设备。',
    secondaryConclusions: [
      'DMA 需总线仲裁可能引入周期窃取。',
      '块传送结束触发一次中断，减少开销。',
    ],
    examTips: ['问“为何 DMA 更高效”可从 CPU 访存次数解释。', '区分可屏蔽中断/不可屏蔽中断。'],
  },
  {
    id: 'cs108',
    category: 'Computer Organization',
    ...
    tags: ['RAID'],
    content:
      'RAID0 条带化无冗余；RAID1 镜像双写；RAID5 条带+奇偶校验分布；RAID6 双奇偶可容忍两盘坏。',
    secondaryConclusions: ['RAID10 读写性能高但代价大。', 'RAID5 写入存在“写放大”，小写需读改写。'],
    examTips: ['题目常让计算可用容量、容错盘数。', '记住 RAID5 奇偶分布避免单一瓶颈。'],
  },
  {
    id: 'cs109',
    category: 'Operating Systems',
    ...
    examTips: ['画状态转移图，标明“调度/阻塞/唤醒”。', '分析开销时要算 TLB 失效和缓存干扰。'],
  },
  {
    id: 'cs110',
    category: 'Operating Systems',
    ...
    content:
      'FCFS 简单但平均等待长；短作业优先最小化平均周转但可能饥饿；RR 兼顾响应；高响应比优先折中；多级反馈队列实现动态时间片。',
    secondaryConclusions: [
      '时间片越小，响应更好但开销更大。',
      '多级反馈队列天然支持 I/O 密集型优先。',
    ],
    examTips: ['计算平均等待/周转需列甘特图。', '注意抢占与非抢占的区别。'],
  },
  {
    id: 'cs111',
    category: 'Operating Systems',
    ...
    content:
      '互斥量仅二值、拥有者才能解锁；信号量可计数，可由任意线程释放，适合资源计数或条件同步。',
    secondaryConclusions: [
      '二值信号量可实现互斥，但缺少所有权概念。',
      '条件变量需配合互斥锁，避免竞争。',
    ],
    examTips: ['P/V 原语要么原子实现，要么屏蔽中断。', '注意信号量初值代表可用资源数。'],
  },
  {
    id: 'cs112',
    category: 'Operating Systems',
    ...
    tags: ['deadlock', '银行家'],
    content:
      '预防从四必要条件入手：破坏互斥/占有等待/不可抢占/循环等待。避免代表银行家算法：保持系统处于安全序列。',
    secondaryConclusions: [
      '资源一次性申请可破坏占有等待但增加浪费。',
      '银行家算法需已知最大需求，适合长期系统。',
    ],
    examTips: ['画资源分配图检查是否存在环。', '银行家算法步骤：Need=Max-Alloc → 找安全序列。'],
  },
  {
    id: 'cs113',
    category: 'Operating Systems',
    ...
    tags: ['同步'],
    content:
      '用三个信号量：empty(缓冲空位)、full(已有项目)、mutex(互斥)。P(empty)→P(mutex)→写→V(mutex)→V(full)。',
    secondaryConclusions: ['避免死锁：信号量获取顺序一致。', '缓冲区为1时退化为单缓冲问题。'],
    examTips: ['写伪代码时对应好 P/V 顺序。', '遇到多生产者/多消费者，仍只需一个互斥即可。'],
  },
  {
    id: 'cs114',
    category: 'Operating Systems',
    ...
    secondaryConclusions: ['读计数为0 才允许写者进入。', '写优先实现：写者到来阻止后续读者进场。'],
    examTips: ['用信号量 queue 实现先来先服务最稳妥。', '别忘记读者退出时计数减到0再释放 writer。'],
  },
  {
    id: 'cs115',
    category: 'Operating Systems',
    ...
    tags: ['安全序列'],
    content:
      '工作向量 Work 初始化为可用资源；寻找 Need≤Work 的进程，假设其完成并释放资源；若能遍历所有进程则安全。',
    secondaryConclusions: [
      '找不到可满足的进程即处于不安全状态。',
      '检测算法与避免算法类似但输入是当前分配。',
    ],
    examTips: ['表格法写清 Need/Work/Allocation 更不易错。', '安全状态≠无死锁，但死锁必为不安全。'],
  },
  {
    id: 'cs116',
    category: 'Operating Systems',
  ...
  },
  {
    ...
    tags: ['工作集'],
    content:
      '工作集 W(t,Δ) 是过去 Δ 时间窗口访问的页集合。缺页率飙升且 CPU 利用率下降是抖动信号，可减少并发进程或增大分配。',
    secondaryConclusions: [
      'PFF（缺页率控制）与工作集策略常结合。',
      'Δ 过大浪费内存，过小频繁抖动。',
    ],
  ...
  },
  {
    ...
    tags: ['TLB'],
    content:
      'TLB 命中直接得到物理帧；未命中需访问多级页表。多级页表节省空间但增加访存层数，TLB 可抵消开销。',
    secondaryConclusions: [
      '有效访存时间 EAT=命中率×1+(1-命中率)×(页表层数+1)。',
      '大页能提高 TLB 命中但可能产生内部碎片。',
    ],
    examTips: ['计算 EAT 时别忘记缺页中断的服务时间。', 'TLB 命中率题常结合局部性给估计值。'],
  },
  {
    id: 'cs119',
    category: 'Operating Systems',
  ...
  },
  {
    ...
    tags: ['thread'],
    content:
      '用户级线程切换快但一次阻塞会阻塞整个进程；内核线程由内核调度，能利用多核但切换成本高。',
    secondaryConclusions: [
  ...
  },
  {
    ...
    tags: ['inode'],
    content:
      'i-node 存权限、时间戳、指向数据块的直接/一次间接/二次间接/三次间接地址，支持大文件扩展。',
    secondaryConclusions: [
  ...
  },
  {
    ...
    tags: ['VFS'],
    content:
      'VFS 抽象统一接口（超级块、inode、dentry、file），允许不同具体文件系统共存。系统调用通过 VFS 分发到具体实现。',
    secondaryConclusions: [
  ...
  },
  {
    ...
    tags: ['window'],
    content:
      '发送窗口限制未确认的数据量，接收窗口通告可用缓存，双方取最小值。超时重传基于 RTT 估计。',
    secondaryConclusions: [
  ...
  },
  {
    ...
    examTips: ['吞吐率计算要代入差错概率和往返时延。', '序号循环问题常考 SR 窗口大小上界。'],
  },
  {
    id: 'cs129',
    category: 'Computer Networks',
    ...
    tags: ['IP'],
    content:
      '分片字段：标识、标志位 DF/MF、片偏移(8B 单位)。DF=1 不允许分片；MTU 决定最大 IP 数据报长度。',
    secondaryConclusions: ['路径 MTU 发现用于避免中途分片。', '片偏移需对齐 8B，最后一片 MF=0。'],
    examTips: ['计算片长时记得每片含首部 20B。', '题目常让写出各片偏移与 MF 位。'],
  },
  {
    id: 'cs130',
    category: 'Computer Networks',
    ...
    tags: ['NAT'],
    content:
      '地址私有化通过 NAT，将内部地址+端口映射到公网。静态映射固定，NAPT 端口复用提高利用率。',
    secondaryConclusions: ['NAT 破坏端到端原则，P2P 需打洞。', 'IPv6 去除 NAT，更依赖防火墙策略。'],
    examTips: [
  ...
  },
  {
    ...
    examTips: ['画出迭代/递归时序，标明返回的提示信息。', '别把递归/迭代与缓存搞混。'],
  },
  {
    id: 'cs132',
    category: 'Computer Networks',
  ...
  },
  {
    ...
    tags: ['TLS'],
    content:
      'TLS1.2：ClientHello→ServerHello+证书→密钥交换→Finished。服务器证书包含公钥，由 CA 签名验证身份。',
    secondaryConclusions: [
      '握手后使用对称密钥加密，提升性能。',
      '中间人攻击防范依赖证书链与主机名校验。',
    ],
  ...
  },
  {
    ...
    tags: ['CDN'],
    content:
      'DNS 调度将用户请求解析到最近的边缘节点；若缓存未命中，回源拉取后再缓存。常用一致性哈希做负载均衡。',
    secondaryConclusions: ['多级缓存可降低回源压力。', '命中率与缓存替换策略（LRU/LFU）相关。'],
    examTips: ['回答“如何提高命中率”可提分级缓存+预热。', 'CDN 与代理/反向代理概念区分。'],
  },
  {
    id: 'cs135',
    category: 'Computer Networks',
    ...
    tags: ['shortest path'],
    content:
      'Dijkstra 需非负权，时间复杂度 O(E logV)；Bellman-Ford 处理负权并能检测负环，复杂度 O(VE)。',
    secondaryConclusions: [
  ...
  },
  {
    ...
    examTips: ['写出 LSA 类型：1 路由、2 网络、3 汇总等。', '邻接建立需 Hello 包参数匹配。'],
  },
  {
    id: 'cs137',
    category: 'Computer Networks',
    ...
    tags: ['ICMP'],
    content:
      'Ping 用 Echo Request/Reply 测 RTT；Traceroute 利用 TTL 递增触发“时间超时”报文记录路径。',
    secondaryConclusions: [
      'ICMP 不保证可靠，可能被防火墙丢弃。',
  ...
  },
  {
    ...
    tags: ['security'],
    content:
      'XSS 注入脚本在受害页面执行；CSRF 利用受害者已登录态跨站请求。防御：输入输出过滤、Content-Security-Policy、SameSite Cookie、双重提交。',
    secondaryConclusions: ['CSRF 需受害者处于登录状态。', '反射型/存储型/DOM 型是 XSS 三类。'],
    examTips: ['写防御措施时区分前端与服务端责任。', '题目常问“SameSite=Lax/Strict”效果。'],
  },
  {
    id: 'cs139',
    category: 'Data Structures',
  ...
  },
  {
    ...
    secondaryConclusions: ['两优化同时使用效果最好。', '可用于 Kruskal 算法检测成环。'],
    examTips: ['写 find 时使用递归压缩路径。', '不要把秩当高度，它是上界。'],
  },
  {
    id: 'cs142',
    category: 'Data Structures',
    ...
    secondaryConclusions: ['next 数组通常右移一位，注意不同教材定义。', 'KMP 保证文本指针不回溯。'],
    examTips: ['手推 π 表时画出前后缀对齐更快。', '代码题小心数组下标，先写模板再改。'],
  },
  {
    id: 'cs143',
    category: 'Data Structures',
    ...
    examTips: ['题目让找“可行计划顺序”多半是拓扑排序。', 'DFS 法要标记三色避免重复访问。'],
  },
  {
    id: 'cs144',
    category: 'Data Structures',
  ...
  },
  {
    ...
    tags: ['shortest path'],
    content:
      'Dijkstra 处理非负边；Bellman-Ford 支持负权并检测负环；SPFA 是队列优化版，最坏仍 O(VE)。',
    secondaryConclusions: [
      '若存在负环，最短路不存在；算法需报告。',
      '多源最短路可加超级源连接所有节点。',
    ],
    examTips: ['写伪代码时标注初始化 dist=∞、源点0。', '避免在含负边图上使用 Dijkstra。'],
  },
  {
    id: 'cs146',
    category: 'Data Structures',
    ...
    tags: ['hash'],
    content:
      '开放定址探查（线性/二次/双重散列）简单但装载因子需 <0.75；链地址用链表或桶，扩容灵活。',
    secondaryConclusions: [
      '线性探查易产生堆积，双重散列分布更均匀。',
  ...
  },
  {
    ...
    examTips: ['写数组堆时左右孩子索引 2i+1/2i+2（0 基）。', '大顶/小顶堆别弄反。'],
  },
  {
    id: 'cs148',
    category: 'Data Structures',
    ...
    secondaryConclusions: ['双模或 64 位自然溢出降低碰撞概率。', '需预计算 B 的幂以支持区间查询。'],
    examTips: ['小心整型溢出，可用 long long 或 __int128。', '碰撞时仍需额外比较以确保正确。'],
  },
  {
    id: 'cs149',
    category: 'Compiler',
    ...
    secondaryConclusions: ['ε-闭包是子集构造关键。', '最小化可用分割算法（Hopcroft）。'],
    examTips: ['画状态图时明确初态/终态和 ε 边。', '最小化题常给等价类划分，照算法迭代即可。'],
  },
  {
    id: 'cs150',
    category: 'Compiler',
    ...
    tags: ['parser'],
    content:
      'LL(1) 自顶向下预测分析需无左递归、无左因子；LR(1) 自底向上，接受更广文法，核心是项目集规范族。',
    secondaryConclusions: [
  ...
  },
  {
    ...
    examTips: ['划分基本块：以入口、分支/跳转目标为界。', '公共子表达式消除等优化在块内实现。'],
  },
  {
    id: 'cs152',
    category: 'Compiler',
    ...
    content:
      '冲突图节点为活跃变量，边表示同时活跃。K 着色成功表示可用 K 个寄存器分配；溢出变量需访存。',
    secondaryConclusions: [
