  ...
  return (
    <div className="mb-12" id="hot-exam">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-3 lg:gap-4 items-start">
        {/* 高频题型 - 全宽水平排布 */}
        <Card className="lg:col-span-12 border-slate-200 bg-white/90 shadow-lg shadow-cyan-100/50 flex flex-col p-4 md:p-5">
        ...
        {/* 时间轴 */}
        <Card className="lg:col-span-3 border-slate-200 bg-white/90 shadow-md flex flex-col p-4 md:p-5 min-h-[260px] max-h-[340px]">
        ...
        {/* 最新权威链接 */}
        <Card className="lg:col-span-4 border-slate-200 bg-white/90 shadow-md flex flex-col p-4 md:p-5 min-h-[260px] max-h-[340px]">
          <div className="flex items-center gap-2 mb-3 text-cyan-600">
            <LinkIcon size={18} />
            <span className="font-semibold">近三个月权威信息（自动爬取优先）</span>
          </div>
          <div className="flex-1 max-h-[280px] overflow-y-auto pr-1 space-y-2 text-sm leading-relaxed">
        ...
        {/* OCR 高频榜 */}
        <Card className="lg:col-span-2 border-slate-200 bg-white/90 shadow-md flex flex-col p-4 md:p-5 min-h-[260px] max-h-[340px]">
        ...
        {/* 复试规则 + 阅卷要点合并，保持同一行宽屏 */}
        <Card className="lg:col-span-3 border-slate-200 bg-white/90 shadow-md flex flex-col p-4 md:p-5 min-h-[280px] max-h-[420px] overflow-hidden">
