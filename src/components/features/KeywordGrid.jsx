  ...
  return (
    <section id="keywords" className="mb-10">
      <div className="flex items-center justify-between mb-3">
        ...
        <span className="text-xs text-slate-500 bg-slate-100 px-3 py-1 rounded-full border border-slate-200">按出现频次排序</span>
      </div>
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {keywords.map((k, idx) => (
          <div key={idx} className="relative overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm hover:shadow-md transition-shadow">
            <div className={`absolute inset-0 opacity-10 bg-gradient-to-br ${palette[k.category] || 'from-slate-200 to-slate-300'}`} aria-hidden />
            <div className="p-4 relative">
              ...
              <div className="text-3xl font-bold text-slate-900">{k.freq}
