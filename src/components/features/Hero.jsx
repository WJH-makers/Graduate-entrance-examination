    ...
    return (
        <div className="relative z-10 flex flex-col items-center justify-center min-h-[85vh] text-center px-4 overflow-hidden">
            ...
            >
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 via-amber-300 to-cyan-300 animate-gradient bg-300%">漫漫</span>
                <br />
            ...
            >
                <Button size="lg" className="group relative overflow-hidden bg-gradient-to-r from-cyan-500 to-amber-400 hover:from-cyan-400 hover:to-amber-300 shadow-lg shadow-cyan-500/25">
                ...
                <Button variant="secondary" size="lg" className="group border border-slate-200/70 bg-white/70 backdrop-blur">
